...
const KNOWN_TABLES = new Set([
  'topics', 'alerts', 'event_clusters', 'daily_status', 'publish_jobs', 'workflow_logs', 'openai_usage_log', 'ai_invocations', 'sources', 'meta_social_publish_log', 'social_publish_log', 'youtube_publish_log', 'rerun_log', 'summary_index'
])
  ...
  db.seed('alerts', [
    {
      ...
      source_metadata_json: JSON.stringify({ supporting_sources: [{ source_name: 'CoinGecko API', source_url: 'https://api.coingecko.com/api/v3/simple/price', source_type: 'api', source_role: 'data' }] }),
      severity_score: 60,
      importance_score: 82,
      confidence_score: 90,
      status: 'active',
